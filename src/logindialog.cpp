...
void loginDialog::saveAccounts()
{
	//add new account to account list
        QSettings settings(QSettings::NativeFormat, QSettings::UserScope, "qutim", "accounts");
...
{
        QSettings settings(QSettings::NativeFormat, QSettings::UserScope, "qutim/ICQ."+account, "account");
...
void loginDialog::deleteCurrentAccount(const QString &account)
{
	...
	if( !ui.accountBox->count() ) ui.deleteButton->setEnabled(false);
        ...
        QSettings dirSettingsPath(QSettings::NativeFormat, QSettings::UserScope, "qutim/ICQ."+account, "account");
