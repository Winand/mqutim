...
m_adhoc->execute(JID(m_server.toStdString()), new Adhoc::Command (m_node.toStdString(), session_id, Adhoc::Command::Executing, d_form->getDataForm()), this );
close();
}
void jAdhoc::doCancel(){
    m_adhoc->execute(JID(m_server.toStdString()), new Adhoc::Command (m_node.toStdString(), session_id, Adhoc::Command::Cancel), this );
    close();
}
void jAdhoc::doNext(){
m_adhoc->execute(JID(m_server.toStdString()), new Adhoc::Command (m_node.toStdString(), session_id, Adhoc::Command::Executing, d_form->getDataForm()), this );
...
void jAdhoc::doPrev(){
m_adhoc->execute(JID(m_server.toStdString()), new Adhoc::Command (m_node.toStdString(), session_id, Adhoc::Command::Previous), this );
close();
}
void jAdhoc::doComplete(){
m_adhoc->execute(JID(m_server.toStdString()), new Adhoc::Command (m_node.toStdString(), session_id, Adhoc::Command::Complete), this );
close();
}
