...
public:
	...
	bool addAccount(const TreeModelItem & Item, QString name);
	bool addGroup(const TreeModelItem & Item, QString name);
	bool addBuddy(const TreeModelItem & Item, QString name);
	...
	bool setItemRow(const TreeModelItem & Item, QList<QVariant> var, int row);
	bool setItemStatus(const TreeModelItem & Item, QIcon icon, QString status, int mass);
