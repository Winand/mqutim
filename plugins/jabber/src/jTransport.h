...
class jTransport : public QObject, RegistrationHandler
{
	Q_OBJECT

public:
	jTransport(Client *jClient, QString jid, QObject *parent = 0);
	virtual ~jTransport();
...
private:
	...
	void handleRegistrationResult(const gloox::JID&, gloox::RegistrationResult res);
