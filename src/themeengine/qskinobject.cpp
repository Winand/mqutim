...
void QSkinObject::updateStyle()
{
	...
	QPixmap up_pix = QPixmap(skinPath + "up.png");
	QPixmap left_pix = QPixmap(skinPath + "left.png");
	QPixmap right_pix = QPixmap(skinPath + "right.png");
	QPixmap down_pix = QPixmap(skinPath + "down.png");
	QPixmap up_left_pix = QPixmap(skinPath + "up_left.png");
	QPixmap up_right_pix = QPixmap(skinPath + "up_right.png");
	QPixmap down_left_pix = QPixmap(skinPath + "down_left.png");
	QPixmap down_right_pix = QPixmap(skinPath + "down_right.png");
...
{
//	QSettings s("/home/osiris/testingqutim/qskinobject-0.6.1/qskinobject-0.6.1/bin/skin/skin.dat", QSettings::NativeFormat);
//	s.beginGroup("Skin");
...
//	titleFont = font;
//	s.endGroup();
        QSettings settings(path_to_border + "config.ini",QSettings::NativeFormat);
